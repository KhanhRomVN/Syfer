...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Syfer warn -> off
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Syfer
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Syfer
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Syfer
		}
	},
	// vscode TS
	{
