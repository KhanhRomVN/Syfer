...
Syfer separately records basic usage like the number of messages people are sending. If you'd like to disable Syfer metrics, you may do so in Syfer's Settings.
`;
