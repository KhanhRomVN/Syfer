...
import { SYFER_OPEN_SETTINGS_ACTION_ID } from '../../syfer/browser/syferSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openSyfer', comment: ['&& denotes a mnemonic'] }, "&&Open Syfer Settings"),
	},
	order: 1
});
