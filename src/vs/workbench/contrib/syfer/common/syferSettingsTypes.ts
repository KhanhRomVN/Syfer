...
import { SyferSettingsState } from './syferSettingsService.js'
...
export type SyferStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with Syfer. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: SyferStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: SyferSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: SyferSettingsState) => {
