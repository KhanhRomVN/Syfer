...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './syferSettingsTypes.js';
...
export type SyferStaticModelInfo = { // not stateful
	// Syfer uses the information below to know how to handle each model.
...
type SyferStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: SyferStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<SyferStaticModelInfo>) => (SyferStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies SyferStaticModelInfo
...
} as const satisfies { [s: string]: Partial<SyferStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: SyferStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<SyferStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: SyferStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: SyferStaticModelInfo }

const anthropicSettings: SyferStaticProviderInfo = {
...
const openAISettings: SyferStaticProviderInfo = {
...
const xAISettings: SyferStaticProviderInfo = {
...
const geminiSettings: SyferStaticProviderInfo = {
...
const deepseekSettings: SyferStaticProviderInfo = {
...
const mistralSettings: SyferStaticProviderInfo = {
...
const groqSettings: SyferStaticProviderInfo = {
...
} as const satisfies Record<string, SyferStaticModelInfo>
const googleVertexSettings: SyferStaticProviderInfo = {
...
const microsoftAzureSettings: SyferStaticProviderInfo = {
...
const awsBedrockSettings: SyferStaticProviderInfo = {
...
const vLLMSettings: SyferStaticProviderInfo = {
...
const lmStudioSettings: SyferStaticProviderInfo = {
...
const ollamaSettings: SyferStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: SyferStaticProviderInfo = {
...
const liteLLMSettings: SyferStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: SyferStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: SyferStaticProviderInfo } = {
