...
export interface ISyferModelService {
	readonly _serviceBrand: undefined;
	initializeModel(uri: URI): Promise<void>;
	getModel(uri: URI): SyferModelType;
	getModelFromFsPath(fsPath: string): SyferModelType;
	getModelSafe(uri: URI): Promise<SyferModelType>;
	saveModel(uri: URI): Promise<void>;

}

export const ISyferModelService = createDecorator<ISyferModelService>('voidSyferModelService');

class SyferModelService extends Disposable implements ISyferModelService {
	_serviceBrand: undefined;
	static readonly ID = 'voidSyferModelService';
	...
	getModelSafe = async (uri: URI): Promise<SyferModelType> => {
...
registerSingleton(ISyferModelService, SyferModelService, InstantiationType.Eager);
