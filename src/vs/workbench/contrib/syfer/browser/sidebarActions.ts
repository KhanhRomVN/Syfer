...
import { VOID_TOGGLE_SETTINGS_ACTION_ID } from './syferSettingsPane.js';
...
const SYFER_OPEN_SIDEBAR_ACTION_ID = 'void.sidebar.open'
registerAction2(class extends Action2 {
	constructor() {
		super({ id: SYFER_OPEN_SIDEBAR_ACTION_ID, title: localize2('voidOpenSidebar', 'Syfer: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: SYFER_CTRL_L_ACTION_ID,
			f1: true,
			title: localize2('voidCmdL', 'Syfer: Add Selection to Chat'),
			keybinding: {
	...
	async run(accessor: ServicesAccessor): Promise<void> {
		...
		if (!wasAlreadyOpen) {
			await commandService.executeCommand(SYFER_OPEN_SIDEBAR_ACTION_ID)
		}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'syfer.settingsAction',
			title: `Syfer's Settings`,
