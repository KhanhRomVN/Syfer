...
import { Diff, DiffArea, SyferFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getSyferFileSnapshot(uri: URI): SyferFileSnapshot;
	restoreSyferFileSnapshot(uri: URI, snapshot: SyferFileSnapshot): void;
}
