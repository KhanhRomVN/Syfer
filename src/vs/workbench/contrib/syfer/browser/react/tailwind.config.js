	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--syfer-fg-1)',
						'--tw-prose-headings': 'var(--syfer-fg-1)',
						'--tw-prose-lead': 'var(--syfer-fg-2)',
						'--tw-prose-links': 'var(--syfer-link-color)',
						'--tw-prose-bold': 'var(--syfer-fg-1)',
						'--tw-prose-counters': 'var(--syfer-fg-3)',
						'--tw-prose-bullets': 'var(--syfer-fg-3)',
						'--tw-prose-hr': 'var(--syfer-border-4)',
						'--tw-prose-quotes': 'var(--syfer-fg-1)',
						'--tw-prose-quote-borders': 'var(--syfer-border-2)',
						'--tw-prose-captions': 'var(--syfer-fg-3)',
						'--tw-prose-code': 'var(--syfer-fg-0)',
						'--tw-prose-pre-code': 'var(--syfer-fg-0)',
						'--tw-prose-pre-bg': 'var(--syfer-bg-1)',
						'--tw-prose-th-borders': 'var(--syfer-border-4)',
						'--tw-prose-td-borders': 'var(--syfer-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'void-bg-1': 'var(--syfer-bg-1)',
				'void-bg-1-alt': 'var(--syfer-bg-1-alt)',
				'void-bg-2': 'var(--syfer-bg-2)',
				'void-bg-2-alt': 'var(--syfer-bg-2-alt)',
				'void-bg-2-hover': 'var(--syfer-bg-2-hover)',
				'void-bg-3': 'var(--syfer-bg-3)',


				'void-fg-0': 'var(--syfer-fg-0)',
				'void-fg-1': 'var(--syfer-fg-1)',
				'void-fg-2': 'var(--syfer-fg-2)',
				'void-fg-3': 'var(--syfer-fg-3)',
				// 'void-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'void-fg-4': 'var(--syfer-fg-4)',

				'void-warning': 'var(--syfer-warning)',

				'void-border-1': 'var(--syfer-border-1)',
				'void-border-2': 'var(--syfer-border-2)',
				'void-border-3': 'var(--syfer-border-3)',
				'void-border-4': 'var(--syfer-border-4)',

				'void-ring-color': 'var(--syfer-ring-color)',
				'syfer-link-color': 'var(--syfer-link-color)',
