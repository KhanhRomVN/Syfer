...
} from "../../../../common/syferSettingsTypes.js";
...
import {
	...
	SettingsForProvider,
	ModelDump,
} from "../syfer-settings-tsx/Settings.js";
...
export const SyferOnboarding = () => {
	...
	return (
		<div className={`@@syfer-scope ${isDark ? "dark" : ""}`}>
			<div
				className={`
...
const SyferIcon = () => {
	...
	return <div ref={divRef} className="@@void-syfer-icon" />;
};
				...
				{providerNamesOfTab[currentTab].map((providerName) => (
					<div key={providerName} className="w-full max-w-xl mb-10">
						<div className="text-xl mb-2">
							...
							{providerName === "gemini" && (
								<span
									data-tooltip-id="syfer-tooltip-provider-info"
...
// 		title:
// 			div
// 				"How would you like to use Syfer?"
// 		content:
	...
	const lastPagePrevAndNextButtons = (
		<div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
			<div className="flex items-center gap-2">
				...
				<PrimaryActionButton
					onClick={() => {
						syferSettingsService.setGlobalSetting("isOnboardingComplete", true);
