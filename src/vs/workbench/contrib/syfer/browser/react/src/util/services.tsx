...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/syfer/common/syferSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { SyferSettingsState } from '../../../../../../../workbench/contrib/syfer/common/syferSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/syfer/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/syfer/common/refreshModelService.js';
import { ISyferSettingsService } from '../../../../../../../workbench/contrib/syfer/common/syferSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/syfer/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/syfer/common/metricsService.js'
...
let settingsState: SyferSettingsState
const settingsStateListeners: Set<(s: SyferSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(ISyferSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		syferCommandBarService: accessor.get(ISyferCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, syferCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		syferCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		syferCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		ISyferSettingsService: accessor.get(ISyferSettingsService),
		...
		ISyferModelService: accessor.get(ISyferModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		ISyferCommandBarService: accessor.get(ISyferCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Syfer useAccessor was called before _registerServices!`)
	}
