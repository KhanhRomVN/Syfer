...
import { TextAreaFns, SyferInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, SyferChatArea } from '../sidebar-tsx/SidebarChat.js';
import { SYFER_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/syfer/common/syferSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(SYFER_CTRL_K_ACTION_ID)?.getLabel()
