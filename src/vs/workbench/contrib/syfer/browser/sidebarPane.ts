...
// const voidViewIcon = registerIcon('void-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Syfer chat view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "Syfer" (Ctrl + L)
...
// open sidebar
export const SYFER_OPEN_SIDEBAR_ACTION_ID = 'syfer.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: SYFER_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open Syfer Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupSyferSidebar';
	constructor(
		@ICommandService private readonly commandService: ICommandService,
	) {
		this.commandService.executeCommand(SYFER_OPEN_SIDEBAR_ACTION_ID)
	}
}
